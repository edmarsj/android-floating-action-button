...
public class FloatingActionsMenu extends ViewGroup {
    ...
    public AddFloatingActionButton getTriggerButton() {
        return mAddButton;
    }
        ...
        switch (mExpandDirection) {
            ...
            case EXPAND_DOWN:
                ...
                for (int i = mButtonsCount - 1; i >= 0; i--) {
                    ...
                    if (child == mAddButton || child.getVisibility() == GONE || !(child.getLayoutParams() instanceof LayoutParams))
                        continue;
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (state instanceof SavedState) {
            ...
            if (mRotatingDrawable != null && isAllowRotation()) {
